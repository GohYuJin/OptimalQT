...
class CustomImageNet(torchvision.datasets.VisionDataset):
    def __init__(self, root, impath_csv, imagenet_class_index_json, transforms=None, target_transforms=None):
        super().__init__(root, transforms=transforms, target_transforms=target_transforms)
